...
- `WORKFLOW.md`: request shape, planning, judgment, operation, validation, and
  completion.
- [`ARCHITECTURE.md`](ARCHITECTURE.md): processes, data flow, and the
  boundaries between them.
- [`product/schema.md`](product/schema.md): the authoritative data model.
...
- `templates/`: optional decision, plan, runbook, and Harness-improvement
  structures.
- [`agents.md`](agents.md): the agent tooling installed in this repository.
